...
| Category | Classes  |
|:---------|:---------|
| **Analysis** | [CrossCorrelate](https://signalflow.dev/library/analysis/crosscorrelate/), [NearestNeighbour](https://signalflow.dev/library/analysis/nearestneighbour/), [OnsetDetector](https://signalflow.dev/library/analysis/onsetdetector/), [VampAnalysis](https://signalflow.dev/library/analysis/vampanalysis/), [YinPitchTracker](https://signalflow.dev/library/analysis/yinpitchtracker/), [ZeroCrossingRate](https://signalflow.dev/library/analysis/zerocrossingrate/) |
...
| **FFT** | [FFTBufferPlayer](https://signalflow.dev/library/fft/fftbufferplayer/), [FFTContinuousPhaseVocoder](https://signalflow.dev/library/fft/fftcontinuousphasevocoder/), [FFTFindPeaks](https://signalflow.dev/library/fft/fftfindpeaks/), [FFTMagnitudePhaseArray](https://signalflow.dev/library/fft/fftmagnitudephasearray/), [FFTNode](https://signalflow.dev/library/fft/fftnode/), [FFTOpNode](https://signalflow.dev/library/fft/fftopnode/), [FFTPhaseVocoder](https://signalflow.dev/library/fft/fftphasevocoder/), [FFT](https://signalflow.dev/library/fft/fft/), [IFFT](https://signalflow.dev/library/fft/ifft/) |
| **Fft: Features** | [FFTSpectralCentroid](https://signalflow.dev/library/fft/features/fftspectralcentroid/), [FFTSpectralFlatness](https://signalflow.dev/library/fft/features/fftspectralflatness/), [FFTSpectralFlux](https://signalflow.dev/library/fft/features/fftspectralflux/) |
| **Fft: Processors** | [FFTContrast](https://signalflow.dev/library/fft/processors/fftcontrast/), [FFTConvolve](https://signalflow.dev/library/fft/processors/fftconvolve/), [FFTCrossFade](https://signalflow.dev/library/fft/processors/fftcrossfade/), [FFTLFO](https://signalflow.dev/library/fft/processors/fftlfo/), [FFTLPF](https://signalflow.dev/library/fft/processors/fftlpf/), [FFTNoiseGate](https://signalflow.dev/library/fft/processors/fftnoisegate/), [FFTRandomPhase](https://signalflow.dev/library/fft/processors/fftrandomphase/), [FFTScaleMagnitudes](https://signalflow.dev/library/fft/processors/fftscalemagnitudes/), [FFTTonality](https://signalflow.dev/library/fft/processors/ffttonality/), [FFTTransform](https://signalflow.dev/library/fft/processors/ffttransform/) |
| **Link** | [AbletonLinkClock](https://signalflow.dev/library/link/abletonlinkclock/), [AbletonLinkPhase](https://signalflow.dev/library/link/abletonlinkphase/), [AbletonLinkBeat](https://signalflow.dev/library/link/abletonlinkbeat/), [AbletonLinkTempo](https://signalflow.dev/library/link/abletonlinktempo/) |
...
| **Physical** | [Maraca](https://signalflow.dev/library/physical/maraca/) |
...
| **Processors: Reverb** | [FeedbackDelayNetwork](https://signalflow.dev/library/processors/reverb/feedbackdelaynetwork/) |
| **Sequencing** | [BlockCounter](https://signalflow.dev/library/sequencing/blockcounter/), [ClockDivider](https://signalflow.dev/library/sequencing/clockdivider/), [Counter](https://signalflow.dev/library/sequencing/counter/), [Euclidean](https://signalflow.dev/library/sequencing/euclidean/), [FlipFlop](https://signalflow.dev/library/sequencing/flipflop/), [ImpulseSequence](https://signalflow.dev/library/sequencing/impulsesequence/), [Index](https://signalflow.dev/library/sequencing/index/), [Latch](https://signalflow.dev/library/sequencing/latch/), [Sequence](https://signalflow.dev/library/sequencing/sequence/), [TriggerMult](https://signalflow.dev/library/sequencing/triggermult/), [TriggerRoundRobin](https://signalflow.dev/library/sequencing/triggerroundrobin/) |
